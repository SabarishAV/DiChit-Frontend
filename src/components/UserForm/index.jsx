...
const UserForm = ()=>{
    ...
    <div className="flex-grow flex justify-center items-center flex-cols w-screen">
        <div className="w-3/6 flex justify-center items-center">
         ...
         <form className="w-full flex items-center justify-center flex-col" action="">
            ...
            <div className="w-full flex justify-center items-center">
                <Button style={{background:"blue",color:"white",borderRadius:"5rem",width:"50%",marginTop:"2rem"}} type="submit">Submit</Button>
            </div>
         </form>
